...
- **Đầu vào**:
  - `features/FT-XXX/01-business-spec.md` — Đặc tả nghiệp vụ (Acceptance Criteria).
...
- **Quy trình**:
  1. Viết kịch bản test E2E/Integration dựa trên Acceptance Criteria từ `01-business-spec.md`.
