...
Trước khi con người ký G1, SA phải đọc `01-business-spec.md` và sinh file `gates/FT-XXX-G1-ba-readiness.md` với kết quả:
- **APPROVED**: Đặc tả đủ rõ để SA có thể thiết kế API + DB. Ghi rõ những điểm tốt.
- **REJECTED**: Ghi rõ mục nào còn thiếu hoặc chưa rõ (VD: thiếu Acceptance Criteria, thuật ngữ chưa định nghĩa trong glossary, luồng nghiệp vụ có khoảng trống). BA phải sửa trước.

## 2. Nhiệm vụ chính

- **Đầu vào:** File `01-business-spec.md` từ tính năng hiện tại (`../../features/FT-XXX/`).
- **Nhiệm vụ:**
